...
getgenv().Key = "{k}"
getgenv().ID = "{user_id}"
loadstring(game:HttpGet("[https://raw.githubusercontent.com/chaudzvn123/dangcap/refs/heads/main/hub](https://raw.githubusercontent.com/chaudzvn123/dangcap/refs/heads/main/hub)"))()
```'''
                        try:
